...
import { GetClimateOldRouteController } from "@src/delivery/controller/service";
...
router.get('/eto', jsonParser, adaptRoute(new GetClimateOldRouteController(new StationGateway())));
