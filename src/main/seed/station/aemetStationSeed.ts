export const aemetStationSeed1 = [
    {
        "latitud": "413515N",
        "provincia": "BARCELONA",
        "altitud": "74",
    ...
    },
    {
        ...
        "altitud": "50",
        "indicativo": "9981A",
        "nombre": "ESTACIÓN DE TORTOSA (ROQUETES)",
        "indsinop": "08238",
        "longitud": "002936E"
    },
    {
...
import { convertDMStoDD } from "@src/main/util";

export const aemetStationSeed = aemetStationSeed1.map(obj => {
    return {
        stationCod: obj.indicativo,
        name: obj.nombre,
        status: "enabled",
        type: "automatic",
        city: obj.nombre,
        state: obj.provincia,
        elevation: obj.altitud,
        country: "ES",
        entity: "aemet",
        lat: convertDMStoDD(obj.latitud),
        lng: convertDMStoDD(obj.longitud)
    }
})